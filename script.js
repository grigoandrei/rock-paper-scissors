...
function win(userChoice, computerChoice) {
  ...
  if (userScore == 10) {
    result_div.textContent = "You won the game !";
    setTimeout(newGame(), 1000);
  } else if (computerScore == 10) {
    result_div.textContent = "Computer has won the game !";
    setTimeout(newGame(), 1000);
  }
}
...
function draw(userChoice, computerChoice) {
  result_div.textContent = `${convertToWord(userChoice)} equals ${convertToWord(
    computerChoice
  )}`;
